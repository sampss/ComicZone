...
class CI_Email {
	...
	var	$smtp_host		= "pod51009.outlook.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "sampss@fullsail.edu";		// SMTP Username
	var	$smtp_pass		= "Wag13nuts";		// SMTP Password
